...
Route::group(['prefix' => 'attendance', 'as' => 'admin.attendance.'], function () {
    ...
    Route::post('approve/{id}', [AttendanceController::class, 'approve'])->name('approve');
    Route::get('monthly/form', [AttendanceController::class, 'monthlyForm'])->name('monthly.form');
...
Route::prefix('course')->group(function () {
    ...
    Route::get('course/add', [CourseController::class, 'addCourse'])->name('admin.course.add_course');
...
Route::prefix('student')->group(function () {
    ...
    Route::post('freeze/{uuid}', [StudentController::class, 'toggleFreeze'])->name('student.freeze');
    Route::post('level-upgrade/{uuid}', [StudentController::class, 'addLevelHistory'])->name('student.level-upgrade');
    Route::post('leave-request/{uuid}', [StudentController::class, 'addLeaveRequest'])->name('student.leave-request');
    Route::post('leave-request-approve/{id}', [StudentController::class, 'approveLeave'])->name('student.leave-request-approve');
    Route::post('feedback/{uuid}', [StudentController::class, 'addFeedback'])->name('student.feedback');
    Route::post('get-states-by-country', [StudentController::class, 'getStatesByCountry'])->name('student.getStatesByCountry');
    Route::post('get-cities-by-state', [StudentController::class, 'getCitiesByState'])->name('student.getCitiesByState');
});
