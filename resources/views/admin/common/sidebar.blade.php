<div class="sidebar__area">
    ...
    <ul id="sidebar-menu" class="sidebar__menu">
        ...
        @endcan
        <li class="{{ active_if_match('admin/attendance') }} {{ active_if_match('admin/attendance/*') }}">
            <a class="has-arrow" href="#">
                <span class="iconify" data-icon="ph:calendar-check"></span>
                <span>{{ __('Attendance') }}</span>
            </a>
            <ul>
                <li class="{{ active_if_match('admin/attendance') }}">
                    <a href="{{ route('admin.attendance.index') }}">
                        <i class="fa fa-circle"></i>
                        <span>{{ __('Records') }}</span>
                    </a>
                </li>
                <li class="{{ active_if_match('admin/attendance/monthly/form') }}">
                    <a href="{{ route('admin.attendance.monthly.form') }}">
                        <i class="fa fa-circle"></i>
                        <span>{{ __('Monthly Sheet') }}</span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        @canany(['manage_course', 'pending_course', 'hold_course', 'approved_course', 'all_course'])
            <li>
                ...
                <ul>
                    ...
                    @can('all_course')
                            <li class="{{ active_if_full_match('admin/course/add') }}">
                                <a href="{{route('admin.course.add_course')}}">
                                    <i class="fa fa-plus-circle"></i>
                                    <span>{{__('Add Courses')}}</span>
                                </a>
                            </li>
                    @endcan
