                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="input__group mb-25">
                                    ...
                                    <span class="text-danger"><i class="fas fa-exclamation-triangle"></i> {{
                                        $errors->first('student_id') }}</span>
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input__group mb-25">
                                    <label>{{ __('Roll No') }}</label>
                                    <input type="text" name="roll_no" value="{{ $student->roll_no }}"
                                        placeholder="Roll No" class="form-control">
                                    @if ($errors->has('roll_no'))
                                    <span class="text-danger"><i class="fas fa-exclamation-triangle"></i> {{
                                        $errors->first('roll_no') }}</span>
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input__group mb-25">
                                    <label>{{ __('Current Level') }}</label>
                                    <input type="text" name="current_level" value="{{ $student->current_level }}"
                                        placeholder="Current Level" class="form-control">
                                    @if ($errors->has('current_level'))
                                    <span class="text-danger"><i class="fas fa-exclamation-triangle"></i> {{
                                        $errors->first('current_level') }}</span>
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input__group mb-25">
                                    ...
                                    <input type="date" name="admission_date" value="{{ $student->admission_date ? $student->admission_date->format('Y-m-d') : '' }}"
                                        class="form-control">
